<template>
  ...
  <div class="edit-view" tabindex="0" @click.self="handleActivated(-1)">
    <div
      class="screen"
    ...
    <box-context-menu ref="contextMenu" :option="contextMenuOption"></box-context-menu>
  </div>
</template>
<script lang="ts">
import {
...
import Mobile from "./container/mobile.vue";
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const handleActivated = function(index: any) {
