<template>
  <div class="box-file-manager">
    <div class="upload-wrap-inline mb16 clearfix">
      <div class="leval-item">
        <el-button size="small" icon="el-icon-plus" @click="addCategory"
          >添加分类</el-button
        >
        <el-popover
          placement="bottom"
        ...
        >
          ...
          <el-button size="small" slot="reference" icon="el-icon-caret-bottom"
            >移动至</el-button
          >
        </el-popover>
        <el-button
    ...
    <category  v-if="isShowCategory" :category="category" @closeCategory="closeCategoryFunc"></category>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    getFileCategory() {
      let self = this;
      let param = {};
      //   FileService.fileCategory(param, true)
      //     .then((data) => {
      //       let type = [
      //         {
      //           group_id: null,
    ...
    getData: function () {
      ...
      //   FileService.fileList(param, true)
      //     .then((data) => {
      //       self.loading = false;
